...
![Parity Generator simulation waveform](simulation/waveform.png)

> **Note on how this waveform was produced:** no Vivado project or
> simulator was available for this module (only the raw source and
> testbench files were provided). The plot above was generated by
> re-implementing the parity logic in Python and running it against the
> same 8 input combinations the testbench sweeps — all match the truth
> table above. If you run the testbench in Vivado's simulator, you can
> export a native waveform to replace this file.
